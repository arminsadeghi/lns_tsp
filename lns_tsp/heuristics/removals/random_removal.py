...
def random_removal(_instance: TSPInstance, tour: list, num_to_remove: int) -> list:
    """Remove a random subset of nodes from the tour."""
    tour_length = len(tour)
    temp_tour = solver_core.random_removal(tour, tour_length, num_to_remove)
